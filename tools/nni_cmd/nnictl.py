...
def parse_args():
    ...
    parser_start.add_argument('--wait', '-w', action='store_true', help='create an experiment and wait for it to terminate')
    ...
    parser_resume.add_argument('--wait', '-w', action='store_true', help='resume an experiment and wait for it to terminate')
