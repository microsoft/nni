...
def parse_args():
    ...
    parser_start.add_argument('--monitor', '-m', action='store_true', help=' set monitor mode')
    ...
    parser_resume.add_argument('--monitor', '-m', action='store_true', help=' set monitor mode')
