...
nnfusion ../artifact_bert_finegrained_onnx_with_tesa/model_tesa.onnx -f onnx -fsparta=true -fkernels_as_files=true -fkernels_files_number=40 -fgelu_fusion=true -fsparse_dot_transpose=true -frun_step 300
