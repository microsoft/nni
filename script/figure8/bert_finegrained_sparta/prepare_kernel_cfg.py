...
bert_ckpt_path = "artifact_bert_finegrained_onnx_with_tesa"
...
bert_ops = load_tesa(bert_ckpt_path)

codegen(bert_ops, "bert_sparta_finegrained_kernels.json")

os.system("rm ~/.cache/nnfusion/kernel_cache.db")
nnfusion_home = os.getenv('NNFUSION_HOME')
assert nnfusion_home is not None
os.system(f"python {nnfusion_home}/src/tools/nnfusion/kernel_db/convert_external_sparta_tesa.py bert_sparta_finegrained_kernels.json")
