cp -r ../../checkpoints/hubert/artifact_hubert_coarse_no_propagation_onnx_with_tesa .
python prepare_kernel_cfg.py --in_dir artifact_hubert_coarse_no_propagation_onnx_with_tesa --out_dir nnfusion_cfg
