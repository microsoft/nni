...
python prepare_kernel_cfg.py --in_dir artifact_bert_coarse_onnx_with_tesa --out_dir ./nnfusion_cfg
cp artifact_bert_coarse_onnx_with_tesa/model_tesa.onnx nnfusion_cfg/
pushd ./nnfusion_cfg
