...
if __name__ == '__main__':
    ...
    hubert_mask_file = 'checkpoints/coarsegrained/hubert_hubert_mask.pth'
    mask = torch.load(mask_file)
    hubert_dummy_input = torch.rand(32, 16000)
    # import ipdb; ipdb.set_trace()
    # '.aten::stack.151'
    # 'hubert.encoder.pos_conv_embed.conv', 'hubert.encoder.pos_conv_embed.padding', 'hubert.encoder.pos_conv_embed.aten::gelu.170'
    ...
    # ms.speedup_model()
    HubertCompressModule(model, ms, propagated_mask)
