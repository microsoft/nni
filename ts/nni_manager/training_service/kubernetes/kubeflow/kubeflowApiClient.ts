...
class TFOperatorClientV1Alpha2 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1alpha2.namespaces(this.getNamespace).tfjobs;
    }
...
class TFOperatorClientV1Beta1 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1beta1.namespaces(this.getNamespace).tfjobs;
    }
...
class TFOperatorClientV1Beta2 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1beta2.namespaces(this.getNamespace).tfjobs;
    }
...
class TFOperatorClientV1 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1.namespaces(this.getNamespace).tfjobs;
    }
...
class PyTorchOperatorClientV1 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1.namespaces(this.getNamespace).pytorchjobs;
    }
...
class PyTorchOperatorClientV1Alpha2 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1alpha2.namespaces(this.getNamespace).pytorchjobs;
    }
...
class PyTorchOperatorClientV1Beta1 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1beta1.namespaces(this.getNamespace).pytorchjobs;
    }
...
class PyTorchOperatorClientV1Beta2 extends KubernetesCRDClient {
    ...
    protected get operator(): any {
        return this.client.apis['kubeflow.org'].v1beta2.namespaces(this.getNamespace).pytorchjobs;
    }
