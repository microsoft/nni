...
* **最新版本**：[v2.7 已发布](https://github.com/microsoft/nni/releases/tag/v2.7) - *2022年4月18日*
* **最新视频 demo**：[Youtube 入口](https://www.youtube.com/channel/UCKcafm6861B2mnYhPbZHavw) | [Bilibili 入口](https://space.bilibili.com/1649051673) - *上次更新：2022年4月18日*
...
* 通过克隆源代码下载示例。
    ...
    ```bash
    git clone -b v2.7 https://github.com/Microsoft/nni.git
    ```
