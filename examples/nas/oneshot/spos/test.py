...
def evaluate_acc(class_cls, criterion, args, train_dataset, val_dataset):
    ...
    test_loader = torch.utils.data.DataLoader(val_dataset, batch_size=args.batch_size, num_workers=args.workers)
...
def _main():
    ...
    evolution_strategy = strategy.RegularizedEvolution(sample_size=1, population_size=2, cycles=2)
