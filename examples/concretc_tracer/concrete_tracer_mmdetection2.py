...
def forward_new(self, img_1):
    ...
    iter_6 = iter(range_1);  range_1 = None
    next_20 = next(iter_6)
    eq_2 = long == next_20
    ...
    roi_head_bbox_roi_extractor_roi_layers = self.roi_head.bbox_roi_extractor.roi_layers
    getitem_27 = roi_head_bbox_roi_extractor_roi_layers[next_20];  roi_head_bbox_roi_extractor_roi_layers = None
    getitem_28 = getitem_20[next_20];  next_20 = None
    call = getitem_27.__call__(getitem_28, getitem_26);  getitem_27 = getitem_28 = getitem_26 = None
    new_zeros[squeeze] = call;  setitem = new_zeros;  squeeze = call = None
    next_21 = next(iter_6)
    eq_3 = long == next_21
    ...
    getitem_29 = getitem_20[next_21];  next_21 = None
    sum_1 = getitem_29.sum();  getitem_29 = None
    ...
    getitem_30 = getitem_20[next_22];  next_22 = None
    sum_2 = getitem_30.sum();  getitem_30 = None
    mul_2 = sum_2 * 0.0;  sum_2 = None
    add_23 = add_22 + mul_2;  add_22 = mul_2 = None
    next_23 = next(iter_6);  iter_6 = None
    eq_5 = long == next_23;  long = None
    ...
    getitem_31 = getitem_20[next_23];  getitem_20 = next_23 = None
    sum_3 = getitem_31.sum();  getitem_31 = None
...
with torch.no_grad():
  ...
  input_b = torch.rand_like(img_tensor)
  
  torch.manual_seed(100)
  out0 = model.forward_dummy(img_tensor)
  torch.manual_seed(100)
  out1 = model.forward_dummy(img_tensor)
  print('out0 == out1:', check_equal(out0, out1))
  torch.manual_seed(100)
  out2 = forward_new(model, img_tensor)
  print('out0 == out2:', check_equal(out0, out2))

  torch.manual_seed(100)
  traced_model = concrete_trace(model, {'img': img_tensor}, False, forwrad_function_name='forward_dummy')
  print('traced code:\n', traced_model.code)
  import dis
  print('forward_new de-asm:\n')
  dis.dis(forward_new)
  print('traced code de-asm:\n')
  dis.dis(traced_model._wrapped_call)

  torch.manual_seed(100)
  out_a0 = model.forward_dummy(img_tensor)
  torch.manual_seed(100)
  out_a1 = traced_model(img_tensor)
  print('out0 == out_a0:', check_equal(out0, out_a0))
  print('out0 == out_a1:', check_equal(out0, out_a1))
  
  torch.manual_seed(100)
  out_b0 = model.forward_dummy(input_b)
  torch.manual_seed(100)
  out_b1 = traced_model(input_b)
  print('out_b0 == out_b1:', check_equal(out_b0, out_b1))