...
if __name__ == '__main__':
    ...
    if 'apoz' in args.pruner:
        pruner = ActivationAPoZRankPruner(model, config_list, trainer, optimizer, criterion, 1)
    else:
        pruner = ActivationMeanRankPruner(model, config_list, trainer, optimizer, criterion, 1)
