...
if __name__ == '__main__':
    ...
    env_params = {'flops_ratio': 0.5, 'lbound': 0.2, 'rbound': 1.,
    ...
    pruner = AMCPruner(model, config_list, 200, dummy_input=dummy_input, finetuner=finetuner, keep_intermediate_result=False,
