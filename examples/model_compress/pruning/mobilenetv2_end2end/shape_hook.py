...
class ShapeHook:
    ...
    def __parse_tensor_shapa(self, args):
        ...
        if isinstance(args, dict):
            ...
            shapes.append(list(args.size()))
        return shapes

    def __get_decorator(self, func, name):
    ...
    def __deploy_hooks(self):
        ...
        for name, module in self.model.named_modules():
            ...
            setattr(module, 'forward', self.__get_decorator(module.forward, name))
