# python main.py --config configs/pruner/vgg16_pruner.yaml --save_name debug --random_seed 2333 --pruner_name L1FilterPruner --pretrain ./experiments/pretrained_models/vgg16_pretrain_cifar10_seed_2333.pth
