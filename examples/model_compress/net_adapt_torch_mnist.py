...
if __name__ == '__main__':
    ...
    def trainer(model):
        '''
        short-term fine tune the model
        '''
        train(args, model, device, train_loader, optimizer, epoch)
        return model
    ...
    pruner = NetAdaptPruner(
        model, configure_list, trainer=trainer, evaluator=evaluator, cool_down_rate=0.5, experiment_data_dir=args.experiment_data_dir)
    pruner.compress()
