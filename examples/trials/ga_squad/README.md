...
Due to the limitation of file upload size, we only upload the source code and complete the data download and training on pai. This experiment requires sufficient memory that `memoryMB >= 32G`, and the training may last for several hours.
