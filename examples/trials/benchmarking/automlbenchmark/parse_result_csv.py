...
def generate_graphs(result_file_name):
    ...
    The graph named task_1.jpg summarizes the best score each tuner gets after n trials. 
    The graph named task_2.jpg summarizes the score each tuner gets in each trial. 
    """
    result = pd.read_csv(result_file_name)
