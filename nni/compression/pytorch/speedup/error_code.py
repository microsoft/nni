...
class EmptyLayerError(SpeedupError):
    def __init__(self):
        super(EmptyLayerError, self)("Pruning a Layer to empty is not legal")

class ShapeMisMatchError(SpeedupError):
    def __init__(self):
        super(ShapeMisMatchError, self)("Shape mismatch!")

class InputsNumberError(SpeedupError):
    def __init__(self):
        super(InputsNumberError, self)("The number of the inputs of the target OP is wrong")
