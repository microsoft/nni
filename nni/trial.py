...
def get_next_parameter() -> Parameters:
    """
    Get the hyperparemeters generated by tuner.
...
def get_sequence_id() -> int:
    """
    Get sequence nubmer of the trial that is currently running.
...
def report_intermediate_result(metric: TrialMetric | dict[str, Any]) -> None:
    ...
    In ``metric`` is a dict, ``metric['default']`` will be used by tuner,
