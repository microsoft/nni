...
class OptimizerConstructHelper(ConstructHelper):
    ...
    def from_trace(model: Module, optimizer_trace: Optimizer):
        ...
        return OptimizerConstructHelper(model, optimizer_trace.trace_symbol, *optimizer_trace.trace_args,
...
class LRSchedulerConstructHelper(ConstructHelper):
    ...
    def from_trace(lr_scheduler_trace: _LRScheduler):
        ...
        return LRSchedulerConstructHelper(lr_scheduler_trace.trace_symbol, *lr_scheduler_trace.trace_args,
