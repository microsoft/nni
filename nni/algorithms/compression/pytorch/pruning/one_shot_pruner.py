...
class L1FilterPruner(OneshotPruner, StructuredFilterPruner):
    """
    Parameters
    ----------
    model : torch.nn.Module
...
class L2FilterPruner(OneshotPruner, StructuredFilterPruner):
    """
    Parameters
    ----------
    model : torch.nn.Module
...
class FPGMPruner(OneshotPruner, StructuredFilterPruner):
    """
    Parameters
    ----------
    model : torch.nn.Module
