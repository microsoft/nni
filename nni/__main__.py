...
from .runtime import tuner_command_channel
...
def main():
    # the url should be "ws://localhost:{port}/tuner" or "ws://localhost:{port}/{url-prefix}/tuner"
    ws_url = os.environ['NNI_TUNER_COMMAND_CHANNEL']
    tuner_command_channel.connect(ws_url)
