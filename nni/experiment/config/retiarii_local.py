...
__all__ = ['RetiariiLocalConfig']

@dataclass(init=False)
class RetiariiLocalConfig(TrainingServiceConfig):
    platform: str = 'retiarii_local'
    ...
    _validation_rules = {
        'platform': lambda value: (value == 'retiarii_local', 'cannot be modified'),
