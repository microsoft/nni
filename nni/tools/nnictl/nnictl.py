...
def get_parser():
    ...
    parser_log_stdout = parser_log_subparsers.add_parser('stdout', description='get stdout information')
    ...
    parser_log_stderr = parser_log_subparsers.add_parser('stderr', description='get stderr information')
    ...
    parser_log_trial = parser_log_subparsers.add_parser('trial', description='get trial log path')
    ...
    # parse algo command
    parser_algo = subparsers.add_parser('algo', description='control nni builtin tuner, assessor and advisor algorithms')
    ...
    parser_algo_unreg = parser_algo_subparsers.add_parser('unregister', aliases=('unreg',), description='unregister algorithm')
    ...
    parser_algo_show = parser_algo_subparsers.add_parser('show', description='show the information of algorithm')
    ...
    parser_algo_list = parser_algo_subparsers.add_parser('list', description='list registered algorithms')
    parser_algo_list.set_defaults(func=algo_list)

    # parse trainingservice command
    parser_ts = subparsers.add_parser('trainingservice', description='control training service')
    ...
    parser_package_subparsers = subparsers.add_parser('package', description='this argument is replaced by algo', prefix_chars='\n')
    ...
    # parse top command
    parser_top = subparsers.add_parser('top', description='monitor the experiment')
