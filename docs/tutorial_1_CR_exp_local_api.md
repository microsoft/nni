...
* Provide a yml experiment configure file
...
This command will be filled in the yml configure file below. Please refer to [here](./howto_1_WriteTrial.md) for how to write your own trial.
...
**Prepare configure file**: Since you have already known which trial code you are going to run and which tuner you are going to use, it is time to prepare the yml configure file. NNI provides a demo configure file for each trial example, `cat ~/nni/examples/trials/mnist-annotation/config.yml` to see it. Its content is basically shown below:
