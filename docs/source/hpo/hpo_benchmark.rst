...
* **tuner**\ : a `tuner or advisor provided by NNI <https://nni.readthedocs.io/en/stable/hpo/tuners.html>`_, or a custom tuner provided by the user.
...
Please refer to `this page <https://nni.readthedocs.io/en/stable/hpo/tuners.html>`_ for more details
on installation.
...
more information on implementing a custom tuner, please refer to `here <https://nni.readthedocs.io/en/stable/hpo/custom_algorithm.html>`_.
Next, perform the following steps:

#. Install the custom tuner via the command ``nnictl algo register``. Check `this document <https://nni.readthedocs.io/en/stable/reference/nnictl.html>`_ for details. 
