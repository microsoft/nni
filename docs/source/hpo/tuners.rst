...
A tuner works like following steps:

 1. Initialize with a search space.
 2. Generate hyperparameter sets from the search space.
 3. Send hyperparameters to trials.
 4. Receive evaluation results from trials.
 5. Update internal state according to the results.
...
you can also implement your own tuner. (FIXME: link)
...
and provides a standard search space. (FIXME: link)
Some tuners, like SMAC, has extra dependencies that need to be installed separately.
...
..  toctree::
    ...
    x<../Tuner/BohbAdvisor>
    x<../Tuner/DngoTuner>
    x<../Tuner/EvolutionTuner>
    x<../Tuner/GPTuner>
    x<../Tuner/GridsearchTuner>
    x<../Tuner/HyperbandAdvisor>
    x<../Tuner/MetisTuner>
    x<../Tuner/NetworkmorphismTuner>
    x<../Tuner/PBTTuner>
    x<../Tuner/RandomTuner>
    x<../Tuner/SmacTuner>
    x<../Tuner/TpeTuner>
