...
可选。 String. Default: eth0 device IP.
...
如果使用定制 Tuner，则为必需。 File path relative to **codeDir**.

Specifies the name of tuner file.

#### className

如果使用定制 Tuner，则为必需。 String.
...
如果使用定制 Assessor，则为必需。 File path relative to **codeDir**.
