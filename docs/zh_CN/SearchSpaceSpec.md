...
* {"_type":"randint","_value":[lower, upper]}
  ...
  * For now, we implement the "randint" distribution with "quniform", which means the variable value is a value like round(uniform(lower, upper)). 所选择值的类型是 float。 如果要使用整数，需要显式转换。
