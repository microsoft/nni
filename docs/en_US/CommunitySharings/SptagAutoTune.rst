...
`SPTAG <https://github.com/microsoft/SPTAG>`_ (Space Partition Tree And Graph) is a library for large scale vector approximate nearest neighbor search scenario released by `Microsoft Research (MSR) <https://www.msra.cn/>`_ and `Microsoft Bing <https://www.bing.com/>`_.
