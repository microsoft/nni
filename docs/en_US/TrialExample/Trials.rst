...
You can try standalone mode with the `mnist example <https://github.com/microsoft/nni/tree/v1.9/examples/trials/mnist-tfv1>`__. Simply run ``python3 mnist.py`` under the code directory. The trial code should successfully run with the default hyperparameter values.
