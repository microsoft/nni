...
* `customized tuner <../Tuner/CustomizeTuner.md>`_
* `customized assessor <../Assessor/CustomizeAssessor.md>`_
* `customized advisor <../Tuner/CustomizeAdvisor.md>`_
...
Reference `customized tuner example <../Tuner/InstallCustomizedTuner.md>`_ for a full example.
