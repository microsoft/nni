...
NNI v1.0 focuses on **Scalability** and **Ease of Use**, with updates like various types of [Tuning Algorithms](./Tuner/BuiltinTuner.md),[Neural Architecture Search Supported](docs/en_US/AdvancedFeature/GeneralNasInterfaces.md),[Multiple Platforms Supported](./TrainingService/SupportTrainingService.md) ,concise visual [WebUI](./Tutorial/WebUI.md) , and friendly  APIs ,NNI has grown into a more intelligent automated machine learning(AutoML) toolkit.
<br/>
<br/>
<br/>
<p align="center">
