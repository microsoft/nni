...
Implementation on NNI is based on the `official implementation <https://github.com/quark0/darts>`_ and a `popular 3rd-party repo <https://github.com/khanrc/pt.darts>`_. DARTS on NNI is designed to be general for arbitrary search space. A CNN search space tailored for CIFAR10, same as the original paper, is implemented as a use case of DARTS.
...
`Example code <https://github.com/microsoft/nni/tree/master/examples/nas/darts>`_
