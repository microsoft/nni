...
Currently, only ENAS and DARTS support visualization. Examples of `ENAS <./ENAS.md>`_ and `DARTS <./DARTS.md>`_ has demonstrated how to enable visualization in your code, namely, adding this before ``trainer.train()``\ :
...
If you are interested in how to customize a trainer, please read this `doc <./Advanced.md#extend-the-ability-of-one-shot-trainers>`_.
...
NAS UI is currently experimental. We welcome your feedback. `Here <https://github.com/microsoft/nni/pull/2085>`_ we have listed all the to-do items of NAS UI in the future. Feel free to comment (or `submit a new issue <https://github.com/microsoft/nni/issues/new?template=enhancement.md>`_\ ) if you have other suggestions.
