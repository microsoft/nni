...
The results are shown in figure below (see the experimenal config `here <https://github.com/microsoft/nni/blob/v1.9/examples/trials/nas_cifar10/config_ppo.yml>`__\ :
