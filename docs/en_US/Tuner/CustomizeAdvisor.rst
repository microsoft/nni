...
**2. Implement the methods with prefix ``handle_`` except ``handle_request``\ **.. You might find `docs <https://nni.readthedocs.io/en/latest/sdk_reference.html#nni.msg_dispatcher_base.MsgDispatcherBase>`_ for ``MsgDispatcherBase`` helpful.
...
Here we provide an `example <https://github.com/microsoft/nni/tree/master/examples/tuners/mnist_keras_customized_advisor>`_.
