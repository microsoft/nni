...
The 'default' op_type stands for the module types defined in `default_layers.py <https://github.com/microsoft/nni/blob/v1.9/src/sdk/pynni/nni/compression/pytorch/default_layers.py>`__ for pytorch.
