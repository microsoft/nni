...
The 'default' op_type stands for the module types defined in `default_layers.py <https://github.com/microsoft/nni/blob/master/src/sdk/pynni/nni/compression/torch/default_layers.py>`_ for pytorch.
