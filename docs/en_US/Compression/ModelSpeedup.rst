...
For complete examples please refer to `the code <https://github.com/microsoft/nni/tree/v1.9/examples/model_compress/model_speedup.py>`__
...
The code of these experiments can be found `here <https://github.com/microsoft/nni/tree/v1.9/examples/model_compress/model_speedup.py>`__.
