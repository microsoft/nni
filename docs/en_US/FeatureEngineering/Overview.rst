...
you could try this `example <https://github.com/microsoft/nni/tree/v1.9/examples/feature_engineering/auto-feature-engineering>`__.
...
* To know more about `Neural Architecture Search with NNI <https://github.com/microsoft/nni/blob/v1.9/docs/en_US/NAS/Overview>`__\ ;
...
* To know more about `Hyperparameter Tuning with NNI <https://github.com/microsoft/nni/blob/v1.9/docs/en_US/Tuner/BuiltinTuner>`__\ ;
