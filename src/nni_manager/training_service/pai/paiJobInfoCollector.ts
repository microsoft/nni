...
export class PAIJobInfoCollector {
    ...
    private getSinglePAITrialJobInfo(protocal: string, paiTrialJob: PAITrialJobDetail, paiToken: string, paiClusterConfig: PAIClusterConfig): Promise<void> {
        ...
        const getJobInfoRequest: request.Options = {
            uri: `${protocal}${paiClusterConfig.host}/rest-server/api/v1/user/${paiClusterConfig.userName}/jobs/${paiTrialJob.paiJobName}`,
            method: 'GET',
            json: true,
               headers: {
