...
class SimulatedAnnealingPruner(Pruner):
    ...
    def __init__(self, model, config_list, optimizer=None, T=100, stop_temperature=20, cool_down_rate=0.9):
        """
        Parameters
        ----------
        model : pytorch model
        ...
        sparsities = self.rescale_sparsities(model, sparsities, config_list['sparsity'])
