...
class TorchGraph:
    ...
    def __init__(self, model=None, dummy_input=None, traced_model=None):
        ...
        if traced_model is not None:
            ...
            raise Exception('Please provide model & dummy_input or the traced_model as inputs')
...
class TorchModuleGraph(TorchGraph):
    ...
    def _expand_non_prim_node(self, node, nodes, input_to_node, output_to_node, module_type, node_name=None):
        """
        ...
        nodepy = NodePyGroup(node_name, module_type, op_type,
