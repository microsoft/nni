...
const  CONCURRENCYTOOLTIP = 'Trial concurrency is the number of trials running concurrently, which is the number of GPUs you want to use if you set gpuNum to 1.';
