...
def create_model(model_type: str):
    pruning_torch_config_list = [{'op_types': ['Linear'], 'exclude_op_names': ['fc1'], 'sparse_ratio': 0.75, 'granularity': 'out_channel'},
    ...
    pruning_lightning_config_list = [{'op_types': ['Linear'], 'exclude_op_names': ['model.fc1'], 'sparse_ratio': 0.75, 'granularity': 'out_channel'},
