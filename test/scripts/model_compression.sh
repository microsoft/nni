...
python3 model_speedup.py --example_name fpgm

echo "testing slim pruning and speedup..."
python3 basic_pruners_torch.py --pruner slim --pretrain-epochs 1 --fine-tune-epochs 1 --model vgg19 --dataset cifar10 --sparsity 0.7
python3 model_speedup.py --example_name slim

echo "testing l1filter pruning and speedup..."
python3 basic_pruners_torch.py --pruner l1filter --pretrain-epochs 1 --fine-tune-epochs 1 --model vgg16 --dataset cifar10 --pretrained-model-dir pretrain_cifar10_vgg16.pth
python3 model_speedup.py --example_name l1filter

echo "testing apoz pruning and speedup..."
python3 basic_pruners_torch.py --pruner apoz --pretrain-epochs 1 --fine-tune-epochs 1 --model vgg16 --dataset cifar10 --pretrained-model-dir pretrain_cifar10_vgg16.pth
...
python3 basic_pruners_torch.py --pruner agp --pretrain-epochs 1 --fine-tune-epochs 1 --model vgg16 --dataset cifar10 --pretrained-model-dir pretrain_cifar10_vgg16.pth

echo 'testing mean_activation pruning'
python3 basic_pruners_torch.py --pruner mean_activation --pretrain-epochs 1 --fine-tune-epochs 1 --model vgg16 --dataset cifar10 --pretrained-model-dir pretrain_cifar10_vgg16.pth
