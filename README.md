    ...
    <tr valign="top">
     ...
     <td style="border-top:#FF0000 solid 0px;">
      ...
      <ul>
        ...
        <td style="border-top:#FF0000 solid 0px;">
      <ul>
        <li><a href="docs/en_US/TrainingService/LocalMode.md">Local running tutorial</a></li>
        <li><a href="docs/en_US/TrainingService/KubeflowMode.md">Run an experiment on Kubeflow</a></li>
        <li><a href="docs/en_US/TrainingService/PaiMode.md">OpenPAI running tutorial</a></li>
        <li><a href="docs/en_US/TrainingService/RemoteMachineMode.md">multiple machines running tutorial</a></li>
      </ul>
      </td>     
    </tr> 
  </tbody>
