  ...
  <tbody>
    ...
    <tr>
      ...
      <ul>
        ...
        <li>Random</li>
        <li>Anneal</li>
        <li>Naive Evolution</li><li>SMAC</li><li>Batch</li><li>Grid</li><li>Hyperband</li><li>Network Morphism</li><li>ENAS</li></ul> Assessor <ul><li>Median Stop</li><li>Curve Fitting</li></ul></td>
