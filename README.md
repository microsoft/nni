    ...
    <tr valign="top">
     ...
     <td style="border-top:#FF0000 solid 0px;">
      ...
      <ul>
        ...
        <li><a href="https://nni.readthedocs.io/en/latest/TrainingService/KubeflowMode.html">Run an experiment on Kubeflow</a></li>
        <li><a href="https://nni.readthedocs.io/en/latest/TrainingService/PaiMode.html">OpenPAI running tutorial</a></li>
        <li><a href="https://nni.readthedocs.io/en/latest/TrainingService/FrameworkControllerMode.html">multiple machines running tutorial</a></li>
      </ul>
      </td>     
    </tr> 
  </tbody>
