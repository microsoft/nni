      ...
      <ul>
        ...
        <li><b>Examples</b></li>
         <ul>
           ...
           <li><a href="docs/en_US/TrialExample/GbdtExample.md">Auto-gbdt (GBDT)</a></li>
           <li><a href="docs/en_US/TrialExample/SquadEvolutionExamples.md">Squad (tensorflow)</a></li>
           <li><a href="docs/en_US/TrialExample/Cifar10Examples.md">Cifar10 (pytorch)</li></a>
           <li><a href="docs/en_US/TrialExample/SklearnExamples.md">Classification (Scikit-learn)</a></li>
           <li><a href="docs/en_US/TrialExample/SklearnExamples.md">Regression (Scikit-learn)</a></li>
              <a href="docs/en_US/SupportedFramework_Library.md">More...</a><br/>
          </ul>
        </ul>
      </td>
