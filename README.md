  ...
  <tbody>
    ...
    <tr valign="top">
      ...
      <td>
        ...
        <br />
        <ul>
          <li style="list-style:none;"><b style="align:left;margin-left:-20px">General Tuner</b></li>
          ...
          <li style="list-style:none;"><b style="align:left;margin-left:-20px">Tuner for HPO</b></li>
          ...
          <li style="list-style:none;"><b style="align:left;margin-left:-20px">Tuner for NAS</b></li> 
          ...
          <a href="docs/en_US/AssessorBuiltinAssessor.md">Assessor</a>
        <ul>
          <li><a href="docs/en_US/AssessorBuiltinAssessor.md#Medianstop">Median Stop</a></li>
          <li><a href="docs/en_US/AssessorBuiltinAssessor.md#Curvefitting">Curve Fitting</a></li>
        </ul>
      </td>
      <td>
      <ul>
    ...
    <tr valign="top">
     <td>
      ...
      <ul>
        ...
        <li><a href="docs/en_US/AdvancedFeature/AdvancedNas.md">Tutorial for Advanced Neural Architecture Search</a></li>
      </ul>
      </td>
        <td>
      <ul>
...
<b>07/1/2019</b> New example support：Add [ENAS-mode](examples/tuners/enas_nni/README.md) and [One-shot mode](docs/en_US/GeneralNasInterfaces.md) for NAS interface.<br />
