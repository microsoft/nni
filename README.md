    ...
    <b>Details</b>
      ...
      <td>
        <ul>
          ...
          <li>Chainer</li>
          <li>Theano</li>
          and some other frameworks and library
        </ul>
        <br>
        Some examples:
         <ul>
         <li><a href="docs/en_US/TrialExample/Cifar10Examples.md">Scikit-learn </a></li>
          <li><a href="docs/en_US/TrialExample/GbdtExample.md">GBDT </a></li>
          <li><a href="docs/en_US/TrialExample/GbdtExample.md">SquadEvolutionExamples</a></li>
          <li><a href="examples/trials/mnist-distributed-pytorch">MNIST-pytorch</li></a>
          <li><a href="docs/en_US/TrialExample/Cifar10Examples.md">Cifar10</li></a>
      ...
      <td align="left" >
        ...
        <ul>
          ...
          <b>Tuner for <a href="docs/en_US/CommunitySharings/HpoComparision.md">HPO</a></b>
          <ul>
          ...
          <b>Tuner for <a href="docs/en_US/CommunitySharings/NasComparision.md">NAS</a></b>
          <ul>
    ...
    <b>References</b>
     ...
     <td style="border-top:#FF0000 solid 0px;">
      ...
      <ul>
        ...
        <li><a href="docs/en_US/CommunitySharings/NasComparision.md">CustomizeAssessor</a></li>
      </ul>
      </td>
        <td style="border-top:#FF0000 solid 0px;">
      <ul>
